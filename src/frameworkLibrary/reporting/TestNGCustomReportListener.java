...
public class TestNGCustomReportListener implements IReporter{
	...
	private String reportTitle= "Automation Report";
	...
	private void startResultSummaryTable(String style) {
		...
		writer.println("<tr style=\"color:White;background-color:rgb(119, 103, 0);\"><th style=\"border: 1px solid #009;padding: .25em .5em;\">Class</th>"
				+ "<th style=\"border: 1px solid #009;padding: .25em .5em;\">Method</th><th style=\"border: 1px solid #009;padding: .25em .5em;\">Exception Info</th><th style=\"border: 1px solid #009;padding: .25em .5em;\">Start Time </th><th style=\"border: 1px solid #009;padding: .25em .5em;\">Execution Time<br/>(hh:mm:ss)</th></tr>");
		m_row = 0;
	}
	...
	private void generateResult(ITestResult ans, ITestNGMethod method,
		...
		if (hasParameters) {
			...
			for (int x = 1; x <= parameters.length; x++) {
				writer.print("<th style=\"border: 1px solid #009;padding: .25em .5em;\">Param." + x + "</th>");
			}
			writer.println("</tr>");
	...
	public void generateSuiteSummaryReport(List<ISuite> suites) {
		...
		writer.print("<tr style=\"color:White;background-color:rgb(119, 103, 0);\">");
	...
	private void summaryCell(String v, boolean isgood) {
		writer.print("<td class=\"numi\" style=\"border: 1px solid #009;padding: .25em .5em;text-align: right;" + (isgood ? "" : "_attn") + "\">" + v
				+ "</td>");
	}
	...
	protected void writeReportTitle(String title) {
		writer.print("<center><h1 style=\"color:White;background-color:rgb(41, 65, 122);\">" + title + " - " + getDateAsString() + "</h1></center>");
	}
